...
const VENDOR_QUESTIONS: VendorCategory[] = [
  ...
  },
  {
    ...
    questions: [
      { id: 'rent-1', question: 'What items do you provide (tables, chairs, linens, tents, etc.)?', category: 'services', priority: 'critical' },
      { id: 'rent-2', question: 'Do you offer delivery and setup? What is the cost?', category: 'pricing', priority: 'critical' },
      { id: 'rent-3', question: 'Do you offer pickup/teardown after the event?', category: 'services', priority: 'critical' },
