        ...
        <div className="bg-white rounded-lg shadow-lg p-8 border border-champagne-100">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              <input type="text" id="name" name="name" value={formData.name} onChange={handleChange} required className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-champagne-600" placeholder="Your name" />
            </div>
            <div>
